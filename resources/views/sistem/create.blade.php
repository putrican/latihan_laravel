            ...
            <div class="col-md-12">
                ...
                <form action="{{ route('sistem.store')}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_orang_tua" id="nama_orang_tua" class="form-control @error('nama_orang_tua') is-invalid @enderror" value="{{ old('nama_orang_tua') }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="minat" id="minat" rows="3" class="form-control @error('minat') is-invalid @enderror" {{ old('minat')}}></textarea>
                        @error('minat')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
